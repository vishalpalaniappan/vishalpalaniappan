...
> [!NOTE]
> Since the trace is instrumented with semantic knowledge that describes the purpose that each logical piece serves in the systems design. This means that the design of the system itself can be reconstructed through the purpose of each abstraction. When a failure occurs, in addition to describing what and how something happened, we can also describe why it happened in the context of the design. As a result, operational intelligence will be able to explain the failure at the design level and identify design flaws.
>
